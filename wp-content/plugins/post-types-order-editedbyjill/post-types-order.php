...
Description: Posts Order and Post Types Objects Order using a Drag and Drop Sortable javascript capability. Edited by Jill - limited to Festival Events, only.
Author: Nsp Code
...
/*                                if (!is_post_type_hierarchical($post_type_name))*/
                        if ($post_type_name == 'festival-event')
